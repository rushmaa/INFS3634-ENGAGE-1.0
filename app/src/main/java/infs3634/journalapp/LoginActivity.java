...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mConsulationButton = (Button) findViewById(R.id.consultation_button);
        mConsulationButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            Call<User> call = ApiClient.getInstance().login(user);
     ...
     * the user.
     */
    public class UserLoginTask extends AsyncTask<Call, Void, User> {
